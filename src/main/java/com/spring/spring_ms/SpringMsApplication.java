package com.spring.spring_ms;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.spring.spring_ms.data.entities.Region;
import com.spring.spring_ms.services.TourPackageService;
import com.spring.spring_ms.services.TourService;
...
public class SpringMsApplication implements CommandLineRunner {
	@Value("/Users/mark/projects/spring_ms/ExploreCalifornia.json")
	...
	public void run(String... args) throws Exception {
		...
		System.out.println(tourService.total()+"helleeeeeeeeeeee");
	}
